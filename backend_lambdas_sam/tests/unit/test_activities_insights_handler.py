...
def apigw_event_get_2022_01(user_id):
    ...
    return {
        ...
        "queryStringParameters": {"starting_date": "2022-01-01", "ending_date": "2022-02-01", "all_categories": False},
        "headers": {
...
def apigw_event_get_by_category(user_id):
    ...
    return {
        ...
        "routeKey": "GET /activityInsights",
        "queryStringParameters": {"starting_date": "2022-01-01", "ending_date": "2022-02-01", "all_categories": True},
        "headers": {
            "Via": "1.1 08f323deadbeefa7af34d5feb414ce27.cloudfront.net (CloudFront)",
            "Accept-Language": "en-US,en;q=0.8",
            "CloudFront-Is-Desktop-Viewer": "true",
