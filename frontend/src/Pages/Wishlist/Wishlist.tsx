  ...
  return (<div className="flex flex-column" >
    ...
    <Form className="flex flex-row" >
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Form.Control type="text" placeholder="Enter URL" value={newUrl} onChange={e => setNewUrl(e.target.value)} />
      </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicEmail">
        <Form.Label>Price</Form.Label>
        <Form.Control type="text" placeholder="Enter price" value={newPrice} onChange={e => setNewPrice(parseInt(e.target.value))} />
      </Form.Group>
