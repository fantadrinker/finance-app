...
export const MonthlyCard = ({
    ...
    const topCategories = isExpanded ? Object.keys(selectedAllCategories).sort((a, b) => {
        ...
        <Card style={cardStyles}>
            <Card.Body>
                ...
                <div style={{
                    ...
                    >
                        ...
                        >
                            {data.map((_, index) => (
                                <Cell 
                                    cursor="pointer" 
                                    fill={index === activeIndex ? '#82ca9d' : (index === hoveredIndex? '#87a9b5': '#8884d8')} 
                                    key={`cell-${index}`} 
                                />
                            ))}
                        </Bar>
                    ...
                    {isExpanded && (
                        <div style={{maxWidth: '360px', maxHeight: '360px'}} onClick={() => setActiveIndex(-1)}>
